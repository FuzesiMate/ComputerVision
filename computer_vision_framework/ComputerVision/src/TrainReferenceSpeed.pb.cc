...
namespace modes3 {
namespace protobuf {
class TrainReferenceSpeedDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<TrainReferenceSpeed> {
...
void TableStruct::Shutdown() {
  _TrainReferenceSpeed_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TrainReferenceSpeed_default_instance_.DefaultConstruct();
}
