...
namespace modes3 {
namespace protobuf {
class TurnoutCommandDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<TurnoutCommand> {
...
void TableStruct::Shutdown() {
  _TurnoutCommand_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TurnoutCommand_default_instance_.DefaultConstruct();
}
