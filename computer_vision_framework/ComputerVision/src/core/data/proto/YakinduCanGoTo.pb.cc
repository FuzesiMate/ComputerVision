...
namespace modes3 {
namespace protobuf {
class YakinduCanGoToDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<YakinduCanGoTo> {
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, -1, sizeof(YakinduCanGoTo)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_YakinduCanGoTo_default_instance_),
};
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "YakinduCanGoTo.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::Shutdown() {
  _YakinduCanGoTo_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _YakinduCanGoTo_default_instance_.DefaultConstruct();
}
...
YakinduCanGoTo::YakinduCanGoTo()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_YakinduCanGoTo_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* YakinduCanGoTo::descriptor() {
  protobuf_YakinduCanGoTo_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_YakinduCanGoTo_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata YakinduCanGoTo::GetMetadata() const {
  protobuf_YakinduCanGoTo_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_YakinduCanGoTo_2eproto::file_level_metadata[kIndexInFileMessages];
}
