...
namespace modes3 {
namespace protobuf {
class TurnoutReferenceStateDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<TurnoutReferenceState> {
...
void TableStruct::Shutdown() {
  _TurnoutReferenceState_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TurnoutReferenceState_default_instance_.DefaultConstruct();
}
