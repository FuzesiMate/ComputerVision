...
namespace modes3 {
namespace protobuf {
class SegmentOccupancyDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<SegmentOccupancy> {
...
void TableStruct::Shutdown() {
  _SegmentOccupancy_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _SegmentOccupancy_default_instance_.DefaultConstruct();
}
