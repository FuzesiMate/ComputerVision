...
extern DccOperationsCommandDefaultTypeInternal _DccOperationsCommand_default_instance_;
class DccOperationsState;
class DccOperationsStateDefaultTypeInternal;
extern DccOperationsStateDefaultTypeInternal _DccOperationsState_default_instance_;
class Marker;
