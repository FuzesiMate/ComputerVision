...
class DccOperationsCommand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.DccOperationsCommand) */ {
 public:
  ...
  static inline const DccOperationsCommand* internal_default_instance() {
    return reinterpret_cast<const DccOperationsCommand*>(
  ...
  inline DccOperationsCommand* New() const PROTOBUF_FINAL { return New(NULL); }

  DccOperationsCommand* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct protobuf_DccOperationsCommand_2eproto::TableStruct;
};
// ===================================================================
