...
class DccOperationsState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:modes3.protobuf.DccOperationsState) */ {
 public:
  ...
  static inline const DccOperationsState* internal_default_instance() {
    return reinterpret_cast<const DccOperationsState*>(
  ...
  inline DccOperationsState* New() const PROTOBUF_FINAL { return New(NULL); }

  DccOperationsState* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct protobuf_DccOperationsState_2eproto::TableStruct;
};
// ===================================================================
